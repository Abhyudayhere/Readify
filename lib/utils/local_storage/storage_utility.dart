...
class ReadifyLocalStorage {
  static final ReadifyLocalStorage _instance = ReadifyLocalStorage._internal();

  factory ReadifyLocalStorage() {
    return _instance;
  }

  ReadifyLocalStorage._internal();
